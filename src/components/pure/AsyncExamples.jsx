...
const AsyncExamples = () => {
    ...
    function showStorage() {
        saveSessionStorage('name', 'Martín')
            .then((response) => {
                ...
                console.log('Name saved and retreived sucessfuly')
                alert('SUCCCESS: Name saved and retreived')
            })
    }
    ...
    const multiPromise = async () => {
        ...
        ).catch((error) => alert(`Something went wrong whit your URLs: ${error} (check your console)`))
    }
    ...
    return (
        <div>
            ...
            <button onClick={multiPromise}>Multiple Promises</button>
        </div>
    );
}
